    ...
    <div class="submittedbox">
        <div class="subtext">
            <?php
                if (isset($_SESSION["username"]))
                {
                    echo "<p2>Booking has been made, <a href='slbookings.php'>Click Here</a> to return to the Bookings page.</p2>";
                }
                else
                {
                    echo "<p2>Account has been created!, <a href='sllogin.php'>Click Here</a> to return to the Login page.</p2>";
                }
            ?>
        </div>
    </div>
